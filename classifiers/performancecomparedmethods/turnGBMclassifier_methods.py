       ...
       #     print(y_train_SVDD)
         ...
         #   print(y_train_combine)
           ...
           # n_train_defect_grid = train_grid[train_grid['label'] == 1].shape[0]
            ...
            best = fmin(
                fn=fn_GBM, space=space_GBM, algo=atpe.suggest, max_evals=100, trials=trials)
            ...
            rf_original = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
            ...
            def hyperopt_model_score_GBM_KNN(params):
                clf = GradientBoostingClassifier(**params)
                return cross_val_score(clf, x_train_original, y_train_original, scoring="roc_auc", cv=2).mean()
            ...
            def fn_GBM_KNN(params):
                acc = hyperopt_model_score_GBM_KNN(params)
                return -acc
            ...
            best = fmin(
                fn=fn_GBM_KNN, space=space_GBM_KNN, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            ...
            rf_KNN = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
                                                     n_estimators=best_n_estimators)
            ...
            def hyperopt_model_score_GBM_Kmeans(params):
                clf = GradientBoostingClassifier(**params)
                return cross_val_score(clf, x_train_original, y_train_original, scoring="roc_auc", cv=2).mean()
            ...
            def fn_GBM_Kmeans(params):
                acc = hyperopt_model_score_GBM_Kmeans(params)
                return -acc
            ...
            best = fmin(
                fn=fn_GBM_Kmeans, space=space_GBM_Kmeans, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            ...
            rf_Kmeans = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
                                                n_estimators=best_n_estimators)
            ...
            def hyperopt_model_score_GBM_SMR(params):
                clf = GradientBoostingClassifier(**params)
                return cross_val_score(clf, x_train_original, y_train_original, scoring="roc_auc", cv=2).mean()
            ...
            def fn_GBM_SMR(params):
                acc = hyperopt_model_score_GBM_SMR(params)
                return -acc
            ...
            best = fmin(
                fn=fn_GBM_SMR, space=space_GBM_SMR, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            ...
            rf_SMR = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
                                                   n_estimators=best_n_estimators)
            ...
            def hyperopt_model_score_GBM_SVDD(params):
                clf = GradientBoostingClassifier(**params)
                return cross_val_score(clf, x_train_original, y_train_original, scoring="roc_auc", cv=2).mean()
            ...
            def fn_GBM_SVDD(params):
                acc = hyperopt_model_score_GBM_SVDD(params)
                return -acc
            ...
            best = fmin(
                fn=fn_GBM_SVDD, space=space_GBM_SVDD, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            ...
            rf_SVDD = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
                                                n_estimators=best_n_estimators)
            ...
            def hyperopt_model_score_GBM_combine(params):
                clf = GradientBoostingClassifier(**params)
                return cross_val_score(clf, x_train_original, y_train_original, scoring="roc_auc", cv=2).mean()
            ...
            def fn_GBM_combine(params):
                acc = hyperopt_model_score_GBM_combine(params)
                return -acc
            ...
            best = fmin(
                fn=fn_GBM_combine, space=space_GBM_combine, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            ...
            rf_combine = GradientBoostingClassifier(max_depth=best_max_depth, max_features=best_max_features,
                                                 n_estimators=best_n_estimators)
        ...
        s3 = "E:/gln/C/myclassoverlap/rebuttal/results/compared/GBM/" + file[i]
