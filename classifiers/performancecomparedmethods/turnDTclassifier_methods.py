     ...
     #       print(y_train_original)
      ...
      #      print(y_train_KNN)
       ...
       #     print(y_train_SVDD)
         ...
         #   print(y_train_combine)
           ...
           # n_train_defect_grid = train_grid[train_grid['label'] == 1].shape[0]
            ...
            def hyperopt_model_score_DT(params):
                ...
                return cross_val_score(clf, x_train_original, y_train_original, scoring="rou_auc",cv=2).mean()
            ...
            def hyperopt_model_score_DT_Kmeans(params):
                clf = DecisionTreeClassifier(**params)
                return cross_val_score(clf, x_train_Kmeans, y_train_Kmeans, scoring="roc_auc",cv=2).mean()
            ...
            def fn_DT_Kmeans(params):
                acc = hyperopt_model_score_DT_Kmeans(params)
                return -acc
            ...
            best = fmin(
                fn=fn_DT_Kmeans, space=space_DT_Kmeans, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            if (best['criterion'] == 0):
                criterion = "gini"
            else:
            ...
            rf_Kmeans = DecisionTreeClassifier(criterion=criterion, max_depth=best_max_depth, min_samples_leaf=best_min_samples_leaf)
            ...
            def hyperopt_model_score_DT_SMR(params):
                clf = DecisionTreeClassifier(**params)
                return cross_val_score(clf, x_train_SMR, y_train_SMR, scoring="roc_auc",cv=2).mean()
            ...
            def fn_DT_SMR(params):
                acc = hyperopt_model_score_DT_SMR(params)
                return -acc
            ...
            best = fmin(
                fn=fn_DT_SMR, space=space_DT_SMR, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            if (best['criterion'] == 0):
                criterion = "gini"
            else:
            ...
            rf_SMR = DecisionTreeClassifier(criterion=criterion, max_depth=best_max_depth, min_samples_leaf=best_min_samples_leaf)
            ...
            def hyperopt_model_score_DT_SVDD(params):
                clf = DecisionTreeClassifier(**params)
                return cross_val_score(clf, x_train_SVDD, y_train_SVDD, scoring="roc_auc",cv=2).mean()
            ...
            def fn_DT_SVDD(params):
                acc = hyperopt_model_score_DT_SVDD(params)
                return -acc
            ...
            best = fmin(
                fn=fn_DT_SVDD, space=space_DT_SVDD, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            if (best['criterion'] == 0):
                criterion = "gini"
            else:
            ...
            rf_SVDD = DecisionTreeClassifier(criterion=criterion, max_depth=best_max_depth, min_samples_leaf=best_min_samples_leaf)
            ...
            def hyperopt_model_score_DT_combine(params):
                clf = DecisionTreeClassifier(**params)
                return cross_val_score(clf, x_train_combine, y_train_combine, scoring="roc_auc", cv=2).mean()
            ...
            def fn_DT_combine(params):
                acc = hyperopt_model_score_DT_combine(params)
                return -acc
            ...
            best = fmin(
                fn=fn_DT_combine, space=space_DT_combine, algo=atpe.suggest, max_evals=100, trials=trials)
            print("Best: {}".format(best))
            if (best['criterion'] == 0):
                criterion = "gini"
            else:
            ...
            rf_combine =DecisionTreeClassifier(criterion=criterion, max_depth=best_max_depth,
        ...
        s3 = "E:/gln/C/myclassoverlap/rebuttal/results/compared/DT/" + file[i]
